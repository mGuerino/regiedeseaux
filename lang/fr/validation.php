...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Messages d'erreur par défaut du validateur. L'application est en français
    | sans langue de secours anglaise : en l'absence de ce fichier, chaque erreur
    | s'affichait sous la forme de sa clé brute (« validation.required »).
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Messages propres à un champ et une règle, sous la forme
    | « attribut.règle ».
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Libellés lisibles substitués à :attribute. Les formulaires Filament
    | fournissent déjà le libellé de chaque champ.
    |
    */
